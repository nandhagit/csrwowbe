...
public class PaymentUtil {
    ...
    private static final String paymentKey = "rgQD2pU9";

    private static final String paymentSalt = "DHWxM7CA1Q";
    ...
    public static PaymentDetail populatePaymentDetail(PaymentDetail paymentDetail){
        ...
        String hash = "";
        //String hashSequence = "phone|surl|furl|lastname|curl|address1|address2|city|state|country|zipcode|pg";
