 ...
 *//**
	...
	*//*
		 ...
		 * List<SimpleGrantedAuthority> lst = new ArrayList<>(); for (Role role :
		 * getRole()) { lst.add(new SimpleGrantedAuthority("ROLE_" + role.getRole())); }
		 * return lst; }
		 * 
		 * public WowUserDetails(WowUser user) { super(user); }
		 * 
