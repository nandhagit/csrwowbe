...
import com.wow.wow.security.JwtAuthenticationEntryPoint;
import com.wow.wow.security.JwtAuthorizationTokenFilter;
import com.wow.wow.service.JwtUserDetailsService;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
		httpSecurity
				...
				.antMatchers("/**").permitAll().antMatchers("/wow/**").permitAll().antMatchers("/payment/**")
				.permitAll().antMatchers("/orders/**").permitAll().antMatchers("/address/**").permitAll()
